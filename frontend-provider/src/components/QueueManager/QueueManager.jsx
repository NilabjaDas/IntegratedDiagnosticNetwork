...
const QueueManager = () => {
    ...
    useEffect(() => {
        const loadConfig = async () => {
            ...
            if (data) {
                // Strictly remove 'Consultation' so Lab Techs cannot see Doctor queues
    ...
    return (
        <Container>
            ...
            <Card bodyStyle={{ padding: 0 }} bordered={false} style={{ borderRadius: '8px', overflow: 'hidden', boxShadow: '0 4px 12px rgba(0,0,0,0.05)' }}>
                <QueueTable 
                    queue={queue} 
